...
needed by the fpgrowth program.
...
but which cannot be processed directly with the fpgrowth program.
...
numbers or column names into a format appropriate for the fpgrowth
...
of the fpgrowth program are written to standard error.
