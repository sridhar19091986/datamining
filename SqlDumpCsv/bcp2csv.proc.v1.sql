...
go
CREATE PROCEDURE stat_hot_gprs(@sortField VARCHAR(500),@sortTopCount int)
as 
BEGIN
declare @sqla varchar(8000)
declare @sqlb varchar(8000)
set @sqla='create view vw_bcpMasterSysobjects
       as      
 ...
 exec(@sqla)
 set @sqlb= 'bcp tempdb..vw_bcpMasterSysobjects out c:\sysobjects.txt -c -t, -T -S' + @@servername
